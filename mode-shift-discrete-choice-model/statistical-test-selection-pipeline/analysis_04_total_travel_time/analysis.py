#!/usr/bin/env python3
"""
analysis.py — Total Travel Time Statistical Test Selection Domain
======================================================
...
outcome  = [c for c in df.columns if "total_travel_time" in c.lower()][0] if "total_travel_time" in df.columns or any("total_travel_time" in c.lower() for c in df.columns) else "total_travel_time"
...
print(f"=== TOTAL TRAVEL TIME ANALYSIS ({len(res_df)} groupings) ===")
if len(res_df) > 0:
