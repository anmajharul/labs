#!/usr/bin/env python3
"""
analysis.py — Demographics Age Statistical Test Selection Domain
======================================================
...
outcome  = [c for c in df.columns if "age" in c.lower()][0] if "age" in df.columns or any("age" in c.lower() for c in df.columns) else "What is your age?"
...
print(f"=== DEMOGRAPHICS AGE ANALYSIS ({len(res_df)} groupings) ===")
if len(res_df) > 0:
