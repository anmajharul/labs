#!/usr/bin/env python3
"""
analysis.py — Access Time Statistical Test Selection Domain
============================================================
...
outcome  = [c for c in df.columns if "access time" in c.lower()][0]
...
print(f"=== ACCESS TIME ANALYSIS ({len(res_df)} groupings) ===")
if len(res_df) > 0:
