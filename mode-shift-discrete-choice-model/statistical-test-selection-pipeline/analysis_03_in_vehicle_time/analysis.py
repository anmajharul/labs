#!/usr/bin/env python3
"""
analysis.py — In-Vehicle Time Statistical Test Selection Domain
================================================================
...
outcome  = [c for c in df.columns if "in-vehicle" in c.lower() or "vehicle time" in c.lower()][0]
...
print(f"=== IN-VEHICLE TIME ANALYSIS ({len(res_df)} groupings) ===")
if len(res_df) > 0:
