...
run_all_analyses.py
===================
Master script to run all 6 statistical pipeline domain analyses sequentially.
...
ANALYSES = [
    "analysis_01_travel_cost",
    "analysis_02_access_time",
    "analysis_03_in_vehicle_time",
    "analysis_04_total_travel_time",
    "analysis_05_likert_comfort_safety",
    "analysis_06_demographics",
]
...
def main() -> None:
    logger.info("=" * 70)
    logger.info("Mode_shift_bubt -- Running All 6 Pipeline Domain Analyses")
    logger.info("=" * 70)
