# ==============================================================================
# analysis.R - Analysis 09: Primary Mode x Dedicated Bus
# ==============================================================================
...
message(rep("=", 60))
message("ANALYSIS 09 (R): Primary Mode x Dedicated Bus")
message(rep("=", 60))

results <- run_full_analysis(
  data_path        = DATA_PATH,
  row_keywords     = c("PRIMARY mode"),
  col_keywords     = c("dedicated BUBT"),
  row_var_label    = "Primary Mode x Dedicated Bus (Row)",
  col_var_label    = "Primary Mode x Dedicated Bus (Col)",
  table_title      = "Table 4.11: Dedicated Bus Intent",
...
cat("\n", rep("=", 60), "\n")
cat(paste0("ANALYSIS 09 RESULTS -- Primary Mode x Dedicated Bus\n"))
cat(rep("=", 60), "\n")
