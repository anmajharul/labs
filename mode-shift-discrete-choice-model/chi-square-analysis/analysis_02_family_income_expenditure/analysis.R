# ==============================================================================
# analysis.R - Analysis 02: Income x Expenditure
# ==============================================================================
...
message(rep("=", 60))
message("ANALYSIS 02 (R): Income x Expenditure")
message(rep("=", 60))

results <- run_full_analysis(
  data_path        = DATA_PATH,
  row_keywords     = c("approximate total monthly income"),
  col_keywords     = c("personal monthly expenditure"),
  row_var_label    = "Income x Expenditure (Row)",
  col_var_label    = "Income x Expenditure (Col)",
  table_title      = "Table 4.3: Expenditure by Income",
...
cat("\n", rep("=", 60), "\n")
cat(paste0("ANALYSIS 02 RESULTS -- Income x Expenditure\n"))
cat(rep("=", 60), "\n")
