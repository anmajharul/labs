#!/usr/bin/env python3
"""
Analysis 04: Trip Purpose x Primary Mode
...
def main() -> None:
    results = run_full_analysis(
        ...
        row_keywords=["primary purpose"],
        col_keywords=["PRIMARY mode"],
        row_var_label="Trip Purpose x Primary Mode (Row)",
        col_var_label="Trip Purpose x Primary Mode (Col)",
        table_title="Table 4.5: Primary Travel Mode by Trip Purpose (n, row %)",
        output_dir=str(OUTPUT_DIR),
        row_order=['Education (Classes/Exam)', 'Work / Job', 'Personal Business'],
    ...
    print(f"Analysis 04 Complete: chi2 = {results['chi2_statistic']:.4f}, p = {results['p_value']:.4f}")
