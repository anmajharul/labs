# ==============================================================================
# analysis.R - Analysis 01: Gender x Primary Mode
# ==============================================================================
...
message(rep("=", 60))
message("ANALYSIS 01 (R): Gender x Primary Mode")
message(rep("=", 60))

results <- run_full_analysis(
  data_path        = DATA_PATH,
  row_keywords     = c("Gender"),
  col_keywords     = c("PRIMARY mode"),
  row_var_label    = "Gender x Primary Mode (Row)",
  col_var_label    = "Gender x Primary Mode (Col)",
  table_title      = "Table 4.2: Mode by Gender",
  output_dir       = OUTPUT_DIR,
  row_order        = c("Male", "Female"),
...
cat("\n", rep("=", 60), "\n")
cat(paste0("ANALYSIS 01 RESULTS -- Gender x Primary Mode\n"))
cat(rep("=", 60), "\n")
