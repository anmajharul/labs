# ==============================================================================
# analysis.R - Analysis 03: Income x Primary Mode
# ==============================================================================
...
message(rep("=", 60))
message("ANALYSIS 03 (R): Income x Primary Mode")
message(rep("=", 60))
...
results <- run_full_analysis(
  ...
  row_var_label    = "Income x Primary Mode (Row)",
  col_var_label    = "Income x Primary Mode (Col)",
  table_title      = "Table 4.4: Mode by Income",
...
cat("\n", rep("=", 60), "\n")
cat(paste0("ANALYSIS 03 RESULTS -- Income x Primary Mode\n"))
cat(rep("=", 60), "\n")
