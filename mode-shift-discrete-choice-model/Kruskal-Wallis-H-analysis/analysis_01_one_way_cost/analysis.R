# ==============================================================================
# analysis.R — One-Way Cost (BDT) Kruskal-Wallis H Test
# ==============================================================================
...
message(rep("=", 60))
message("ANALYSIS (R): One-Way Cost (BDT)")
message(rep("=", 60))
...
kw_res <- kruskal_wallis_manual_r(df, "one_way_cost", "primary_mode")
es_res <- kw_effect_size_r(kw_res$H_corrected, kw_res$N, kw_res$df + 1)
dunn   <- dunn_bonferroni_r(df, "one_way_cost", "primary_mode")

cat("
", rep("=", 60), "
")
cat("KRUSKAL-WALLIS RESULTS -- One-Way Cost (BDT)
")
cat(rep("=", 60), "
")
