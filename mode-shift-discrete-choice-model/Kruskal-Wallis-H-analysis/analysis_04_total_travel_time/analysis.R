# ==============================================================================
# analysis.R — Total Travel Time (min) Kruskal-Wallis H Test
# ==============================================================================
...
message(rep("=", 60))
message("ANALYSIS (R): Total Travel Time (min)")
message(rep("=", 60))
...
kw_res <- kruskal_wallis_manual_r(df, "total_travel_time", "primary_mode")
es_res <- kw_effect_size_r(kw_res$H_corrected, kw_res$N, kw_res$df + 1)
dunn   <- dunn_bonferroni_r(df, "total_travel_time", "primary_mode")

cat("
", rep("=", 60), "
")
cat("KRUSKAL-WALLIS RESULTS -- Total Travel Time (min)
")
cat(rep("=", 60), "
")
