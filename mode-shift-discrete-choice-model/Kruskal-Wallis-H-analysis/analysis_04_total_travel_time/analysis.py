#!/usr/bin/env python3
"""
analysis.py — Total Travel Time (min) Kruskal-Wallis Analysis
===================================================
...
print(f"=== KRUSKAL-WALLIS: TOTAL TRAVEL TIME (MIN) ===")
