...
def main():
    ...
    col_name = detect_column(df, "comfort")
    ...
    res = compute_mann_whitney_full(male_vals, female_vals, "Comfort")
    ...
    export_table_4_4_docx(res, "Comfort", str(CURRENT_DIR / "publication_table.docx"))
    print("04_comfort analysis completed successfully.")
