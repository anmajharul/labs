...
* 3. Replace comfort with the exact SPSS variable name.
* ============================================================.

* GET FILE='C:\YOUR_PATH\chapter4_raw.sav'.

TEMPORARY.
SELECT IF NOT MISSING(Gender) AND NOT MISSING(comfort).

NPAR TESTS
  /MANN-WHITNEY = comfort BY Gender(1 2)
  /MISSING ANALYSIS.

* Descriptive means/medians for direct comparison with Table 4.4.
MEANS TABLES=comfort BY Gender
