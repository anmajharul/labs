#!/usr/bin/env python3
"""
mann_whitney_03_road_accidents.py
"""
import sys
import os
...
def main():
    ...
    col_name = detect_column(df, "road_accidents")
    ...
    res = compute_mann_whitney_full(male_vals, female_vals, "Safety: Road Accidents")
    
    results_df = pd.DataFrame([{
        "analysis": "Safety: Road Accidents",
        "n1_male": res["n1_male"],
    ...
    export_table_4_4_docx(res, "Safety: Road Accidents", str(CURRENT_DIR / "publication_table.docx"))
    print("03_road_accidents analysis completed successfully.")
